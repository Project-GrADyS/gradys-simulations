...
void CentralizedQProtocol::handleTelemetry(projeto::Telemetry *telemetry) {
...
void CentralizedQProtocol::rendevouz() {
...
void CentralizedQProtocol::updatePayload() {
...
void CentralizedQProtocol::setTarget(const char *target) {
    CommunicationCommand *command = new CommunicationCommand();
...
bool CentralizedQProtocol::isTimedout() {
...
void CentralizedQProtocol::resetParameters() {
    timeoutSet = false;
