...
struct OPEN_DRONE_ID_SYSTEM : mavlink::Message {
    ...
    inline void serialize(mavlink::MsgMap &map) const override
    {
        ...
        map << area_count;                    // offset: 20
        map << area_radius;                   // offset: 22
        map << target_system;                 // offset: 24
        map << target_component;              // offset: 25
        map << id_or_mac;                     // offset: 26
        map << operator_location_type;        // offset: 46
        map << classification_type;           // offset: 47
        map << category_eu;                   // offset: 48
        map << class_eu;                      // offset: 49
    }
