...
TEST(common, GROUP_START)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::GROUP_START packet_in{};
    packet_in.group_id = 963497880;
    packet_in.mission_checksum = 963498088;
    packet_in.time_usec = 93372036854775807ULL;

    mavlink::common::msg::GROUP_START packet1{};
    mavlink::common::msg::GROUP_START packet2{};
...
#ifdef TEST_INTEROP
TEST(common_interop, GROUP_START)
{
    mavlink_message_t msg;
...
TEST(common, GROUP_END)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::common::msg::GROUP_END packet_in{};
    packet_in.group_id = 963497880;
    packet_in.mission_checksum = 963498088;
    packet_in.time_usec = 93372036854775807ULL;

    mavlink::common::msg::GROUP_END packet1{};
    mavlink::common::msg::GROUP_END packet2{};
