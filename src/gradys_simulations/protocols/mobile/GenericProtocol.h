...
#ifndef __gradys_simulations_GenericPROTOCOL_H_
#define __gradys_simulations_GenericPROTOCOL_H_

#include <omnetpp.h>
#include "../base/CommunicationProtocolBase.h"
#include "../messages/network/GenericMessage_m.h"
...
/*
 * GenericProtocol implements a protocol that recieves and sends GenericMessages to simulate a
 ...
 */
class GenericProtocol : public CommunicationProtocolBase
{
    protected:
        ...
        GenericMessage lastPayload = GenericMessage();
