...
#ifndef gradys_simulations_MOBILITY_BASE_MAVLINKINSTRUCTION_H_
#define gradys_simulations_MOBILITY_BASE_MAVLINKINSTRUCTION_H_
...
#endif /* gradys_simulations_MOBILITY_BASE_MAVLINKINSTRUCTION_H_ */
