...
#  opp_makemake --nolink -f --deep -O out -KINET4_5_PROJ=../inet4.5 -DINET_IMPORT -I. -I/home/lac/.pyenv/versions/3.11.4/include/python3.11 -I$$\(INET4_5_PROJ\)/src -L$$\(INET4_5_PROJ\)/src -lINET$$\(D\) -d src -X.
#
