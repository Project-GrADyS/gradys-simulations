...
void ZigzagProtocolSensor::handleTelemetry(projeto::Telemetry *telemetry) {
...
void ZigzagProtocolSensor::sendReverseOrder() {
...
bool ZigzagProtocolSensor::isTimedout() {
...
void ZigzagProtocolSensor::resetParameters() {
    timeoutSet = false;
