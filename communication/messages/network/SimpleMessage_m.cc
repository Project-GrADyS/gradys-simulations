...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("inet::SenderType");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("inet::SenderType"));
    e->insert(DRONE, "DRONE");
    e->insert(SENSOR, "SENSOR");
    e->insert(GROUND_STATION, "GROUND_STATION");
)
...
inet::SenderType SimpleMessage::getSenderType() const
{
    return this->senderType;
}

void SimpleMessage::setSenderType(inet::SenderType senderType)
{
    handleChange();
    this->senderType = senderType;
}

int SimpleMessage::getContent() const
{
    return this->content;
}

void SimpleMessage::setContent(int content)
{
    handleChange();
...
int SimpleMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 's' && strcmp(fieldName, "senderType") == 0) return base+0;
...
bool SimpleMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    SimpleMessage *pp = (SimpleMessage *)object; (void)pp;
    switch (field) {
        case FIELD_senderType: pp->setSenderType((inet::SenderType)string2enum(value, "inet::SenderType")); return true;
        case FIELD_content: pp->setContent(string2long(value)); return true;
